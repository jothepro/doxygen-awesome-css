...
- 🌘 Dark mode support!
- 🥇 Works best with **Doxygen 1.9.1** - **1.9.4** and **1.9.6** - **1.18.0**
...
```sh
cd your-project
npm install https://github.com/jothepro/doxygen-awesome-css#v2.5.0 --save-dev
...
- Chrome 153, Chrome 152 for Android, Chrome 141 for iOS
- Safari 26, Safari for iOS 26
- Firefox 155, Firefox 142 for Android, Firefox 148 for iOS
- Edge 152
- Opera One 135
